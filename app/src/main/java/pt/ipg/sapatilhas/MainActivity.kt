...
import pt.ipg.sapatilhas.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        val opcaoProcessada = when (fragment) {
            ...
            is NewSapatilhaFragment-> (fragment as SneakerListFragment).processaOpcaoMenu(item)
            else -> false
        }
       ...
       /*
        if(fragment is SneakerListFragment){
            (fragment as SneakerListFragment).processaOpcaoMenu(item)
        } else{
            //menu principal ou sobre
